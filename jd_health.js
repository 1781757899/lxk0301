...
const inviteCodes = [`T020a0jwlZS1Id5r9ZpVQ0-NCjVUnoaW5kRrbA`, 'T0205KkcAmt7tByidEG9_pdsCjVUnoaW5kRrbA', `T0205KkcI3h-vRWXUnKt74BcCjVUnoaW5kRrbA`, `T0205KkcGGd-vDSuakWV851tCjVUnoaW5kRrbA`];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
